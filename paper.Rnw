...
segmentation in standard 3T T1 images, using five high-resolution manually
segmented atlases \citep{Winterburn2013}.
...
CA4/DG and subiculum subfields with an DSC overlap scores of 0.56, 0.65, 0.58,
respectively. 

\textbf{Conclusion:} We demonstrate that \mb{} produces accurate whole
hippocampal segmentations using at most only 9 atlases with various hippocampal
definitions, disease populations, and image acquisition types, as well we show
