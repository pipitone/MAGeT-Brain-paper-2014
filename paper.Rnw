...
caption = paste(
  "Pearson correlation between manual (SNT) whole hippocampus volume", 
  "and whole hippocampus volume by method.", sep=" ")
latex(snt.tests, file="", 
      size="scriptsize",
      caption=caption, row.names="",
      title="")
@
...
@
  ...
  in the ADNI1 1.5T 1Yr Complete dataset.}
