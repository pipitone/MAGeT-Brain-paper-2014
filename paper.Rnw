...
\ants registration shows increased segmentation accuracy over \mb with \animal
...
@
  ...
  \caption{
  {\em \mb mean DSC by atlas and template library size, registration algorithm,
  and label fusion method. Mean DSC is calculated over each subject from the
  ADNI1 Cross-Validation } 
  }
\end{figure}
...
%%%%%
\subsection{ADNI1 Screening Validation}
...
package_totals = data.frame(
  Screening  = c(length(subjects$VISCODE), 'N/A'),
...
latex(package_totals, file="", size="scriptsize", 
    caption="ADNI1 1.5T Screening Dataset Segmentations",
    title="",
    label="tab:ADN1-1.5T-Screening-Dataset-Segmentations")
@
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
