...
qplot(DX,value,data=melt(totals,id.vars=c("ID","DX"),measure.vars=c("FSL","MAPER","MAGeT","SNT"),na.rm=T),
...
by_snt_volumes = melt(totals,id.vars=c("ID","SNT"), measure.vars=c("FSL","MAPER","MAGeT"))
