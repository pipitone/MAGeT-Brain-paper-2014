...
ggplot(subset(stats.tests, direction > 0 & stat == "Variance"), 
  ...
  scale_y_log10(limits=c(0.0002,1), breaks=c(0.01,0.05,0.1,1.0)) + 
  xlab( "Number of Templates" ) + 
  ylab( "Difference of variance during validation (log(p))") +
...
@
  ...
  accuracy with respect to manual segmentation.}
  ...
  than \multiatlas are shown. Dashed lines indicate a p-value of 0.05 and 0.01.}
