...
tab <- summary(DX.bl ~ AGE + PTGENDER + PTEDUCAT + CDRSB + ADAS13 +
               ...
               jens_atlasess$RID, method = "reverse", test=FALSE, overall=TRUE)
caption = 
...
@
  ...
  Pruessner \gs{} segmentations for 69 ADNI subjects vs. atlas and template library
...
% 
% - take away: MB produces subfields volumes that are comparable or better than
