...
latex(tab, file="", size="scriptsize",landscape=FALSE, ctable=TRUE,
      caption="ADNI-1 1.5T Screening demographics")
@
...
latex(merge(a_ma_means, t_ma_means, by="num_atlases"), colheads=c("Atlases", "ANTS", "ANIMAL"), file="", dec=2)
@
\begin{table}
    \begin{tabular}{c|c|c}
