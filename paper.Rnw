...
CA2/CA3 subregions. The CA4/DG subregion shows significantly lower percent error 
  ($M_{res}=$\Sexpr{wa.s$m_res[wa.s$region=='CA4/DG']},
  $SD_{res}=$\Sexpr{wa.s$sd_res[wa.s$region=='CA4/DG']};
  $M_{mb-bravo}=$\Sexpr{wa.s$m_bravo[wa.s$region=='CA4/DG']},    
  $SD_{mb-bravo}=$\Sexpr{wa.s$sd_bravo[wa.s$region=='CA4/DG']};    
  $M_{mb-res}=$\Sexpr{wa.s$m_mb_res[wa.s$region=='CA4/DG']},    
  $SD_{mb-res}=$\Sexpr{wa.s$sd_mb_res[wa.s$region=='CA4/DG']};    
  $p < 0.001$), and the SR/SL/SM shows significantly different percent error in the opposite
direction 
  ($M_{res}=$\Sexpr{wa.s$m_res[wa.s$region=='SR/SL/SM']},
  $SD_{res}=$\Sexpr{wa.s$sd_res[wa.s$region=='SR/SL/SM']};
  $M_{mb-bravo}=$\Sexpr{wa.s$m_bravo[wa.s$region=='SR/SL/SM']},    
  $SD_{mb-bravo}=$\Sexpr{wa.s$sd_bravo[wa.s$region=='SR/SL/SM']};    
  $M_{mb-res}=$\Sexpr{wa.s$m_mb_res[wa.s$region=='SR/SL/SM']},    
  $SD_{mb-res}=$\Sexpr{wa.s$sd_mb_res[wa.s$region=='SR/SL/SM']};    
...
subregions, and a noticeable fixed bias in the CA4/DG and SR/SL/SM subregions. 
