...
% atlas-based methods -> a prior feature based methods?
%
% - basic multi-atlas method, Collins2010: large atlas library, atlas selection
% (Aljabar), and label fusion.
% - Lotjonen, Leung, Heckeman2011 (MAPER) as variations on the theme.
% - Coutin's use of shape-based priors
%
% - multi-atlas with specialised/small atlas libraries
%   - Fischl - freesurfer, high-resolution atlases + probability priors
%   - Yuskevitch - 
%  
...
%
%
Fully-automated segmentation techniques overcome the need for human expertise.
In particular, {\it atlas-based} approaches make use of one or more expertly
segmented MRIs (the atlas library) as templates to guide the segmentation of a
query subject's MRI
...
Multi-atlas hippocampal segmentation algorithms achieve some of the best
automated segmentation accuracies to-date, and approach the performance of a
manual rater
\citep{Heckemann2011,Collins2010,Aljabar2009,Leung2010,Lotjonen2010}, but rely
