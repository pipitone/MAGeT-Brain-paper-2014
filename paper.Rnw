...
\item check that chart labels are sensible 
...
\item experiment references formatted as Experiment 2 (Section 3.2)
...
parameter settings on brain images of young, first episode Schizophrenia
patients. 
\item Experiment 3 assesses hippocampal subfield segmentation quality in a
leave-one-out cross-validation design. 
\item Experiment 4 compares \mb{} segmentations with those of well-known
automated methods on the entire \adnidataset image dataset consisting of 
...
%%%%%                                                                     %%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Experiment 1: Whole Hippocampus Segmentation --- Cross-Validation on 
...
%%%%%                                                                     %%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Experiment 2: Whole Hippocampus Segmentation --- Cross-validation
on First Episode Schizophrenia Subjects}
\label{exp:fep-xval}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%                                                                     %%%%%
%%%%%        Experiment 3: Hippocampal Subfield Cross-Validation          %%%%%
%%%%%                                                                     %%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Experiment 3: Hippocampal Subfield Segmentation --- Cross-Validation
on the Winterburn Atlases}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%    RESULTS: Experiment 3: Hippocampal Subfield Cross-Validation     %%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Results}
...
%%%%%                                                                     %%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Experiment 4: Application to the segmentation of Alzheimer's
disease patients}
\label{exp:adni}
...
atlases (described in Experiment 3, section \ref{exp:winterburn-xval}), and size of template library,
...
(CN); SZ = Schizophrenia; LOOCV = Leave-one-out cross-validation; MCCV = Monte Carlo
cross-validation; SNT = Surgical Medtronic Navigation Technologies
